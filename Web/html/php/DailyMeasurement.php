<?php
	...
	$query="SELECT * FROM DailyMeasurement";
	...
	foreach ($conn->query($query) as $row) {
		$sqlarray = array();
		$sqlarray["Time"] = $row['datetime'];
		$sqlarray["Temperature"] = $row['temperature'];
		$sqlarray["Humidity"] = $row['humidity'];
		$sqlarray["SoilMoisture"] = $row['moisture'];
		$sqlarray["UV"] = $row['uv'];
